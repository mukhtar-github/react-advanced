...
We'll create id when collecting the person object in the array. We can use index instead of id, but it will not be suitable because, we are adding and removing items in the array.

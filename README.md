...
We set our pages inside a Route, and then we have a path property (prop), this is where we showcase what is going to be our URL. And the first one is the home page, and for the home page we just go with '/', that just means the domain name.

...
Once we've refactor to basic useReducer setup. Now let's see how the dispatch works, how the reducer works, and what is action. In order to efect anything in our state, we'll need to dispatch them. We always need to pass an object to our dispatch function, with the property of type.

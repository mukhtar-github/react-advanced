...
We're going to use the assigned useRef container (refContainer) as a ref attribute inside the input element. Since useRef doesn't trigger re-render, we don't worry about the dependency array.

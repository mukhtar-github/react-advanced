...
useRef works alot more like useState. However there's some difference. We use useRef for targeting *DOM elements*, and inturn allows us to setup *uncontrolled inputs*.
